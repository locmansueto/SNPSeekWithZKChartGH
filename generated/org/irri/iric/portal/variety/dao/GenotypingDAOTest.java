...
public class GenotypingDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private GenotypingDAO dataStore;

	/**
	 * Instantiates a new GenotypingDAOTest.
	 *
	 */
	public GenotypingDAOTest() {
	}

	/**
	 * Method to test Genotyping domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Genotyping() {
		Genotyping instance = new Genotyping();
	 ...
	 */
	@Autowired
	public void setDataStore(GenotypingDAO dataStore) {

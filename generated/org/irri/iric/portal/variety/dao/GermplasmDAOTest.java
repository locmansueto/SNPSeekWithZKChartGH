...
public class GermplasmDAOTest {
	 ...
	 *
	 */
	private GermplasmDAO dataStore;

	/**
	 * Instantiates a new GermplasmDAOTest.
	 *
	 */
	public GermplasmDAOTest() {
	}

	/**
	 * Method to test Germplasm domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void Germplasm() {
		Germplasm instance = new Germplasm();
	 ...
	 */
	@Autowired
	public void setDataStore(GermplasmDAO dataStore) {

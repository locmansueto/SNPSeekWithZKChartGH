...
public class PhenGcDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private PhenGcDAO dataStore;

	/**
	 * Instantiates a new PhenGcDAOTest.
	 *
	 */
	public PhenGcDAOTest() {
	}

	/**
	 * Method to test PhenGc domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void PhenGc() {
		PhenGc instance = new PhenGc();
	 ...
	 */
	@Autowired
	public void setDataStore(PhenGcDAO dataStore) {

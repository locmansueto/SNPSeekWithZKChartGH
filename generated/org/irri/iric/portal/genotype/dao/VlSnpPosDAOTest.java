...
public class VlSnpPosDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VlSnpPosDAO dataStore;

	/**
	 * Instantiates a new VlSnpPosDAOTest.
	 *
	 */
	public VlSnpPosDAOTest() {
	}

	/**
	 * Method to test VlSnpPos domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VlSnpPos() {
		VlSnpPos instance = new VlSnpPos();
	 ...
	 */
	@Autowired
	public void setDataStore(VlSnpPosDAO dataStore) {

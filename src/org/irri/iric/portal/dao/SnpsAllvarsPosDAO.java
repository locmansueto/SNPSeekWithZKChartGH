...
public interface SnpsAllvarsPosDAO {
	...
	*/
	...
	/*
	public static BigDecimal TYPE_GQ92BASESNP = new BigDecimal(16);
	public static BigDecimal TYPE_GQ92FILTEREDSNP = new BigDecimal(17);
	public static BigDecimal TYPE_GQ92CORESNP = new BigDecimal(18);
	*/
	...
	long countSNPs(String chr, Integer startPos, Integer endPos, BigDecimal type);
	*/

	public List getSNPs(String chromosome, Integer startPos, Integer endPos , Set variantset);
//	List getSNPs(String chromosome, Integer startPos, Integer endPos, BigDecimal type);

	public List getSNPs(String chromosome, Integer startPos, Integer endPos, Set variantset, int firstRow, int maxRows);
//	public List getSNPs(String chromosome, Integer startPos, Integer endPos, BigDecimal variantset, int firstRow, int maxRows);

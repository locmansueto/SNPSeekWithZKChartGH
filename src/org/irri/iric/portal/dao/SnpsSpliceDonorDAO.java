...
public interface SnpsSpliceDonorDAO {
	...
	public Set<SnpsSpliceDonor> getSNPsBetween(String chr, Integer start, Integer end, Set variantset) throws DataAccessException;
	public Set<SnpsSpliceDonor> getSNPsIn(String chr, Collection listpos, Set variantset) throws DataAccessException;

	//public Set<SnpsSpliceDonor> getSNPsBetween(String chr, Integer start, Integer end, BigDecimal dataset) throws DataAccessException;
	//public Set<SnpsSpliceDonor> getSNPsIn(String chr, Collection listpos, BigDecimal dataset) throws DataAccessException;

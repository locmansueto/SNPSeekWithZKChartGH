...
public class SeedPriceDAO {
	...
	/*
	 * public Double getPrice(int grams, String country, String stockType, String
	 * userType) {
	 * 
	 * if(userType.equals("pub")) { String countryCat=getCountryCateogory(country);
	 * if(countryCat.equals("")) { if(grams<=10) return 0.0; else return
	 * getPricePer10gram( stockType, countryCat)*(grams-10)/10; } else return
	 * getPricePer10gram( stockType, countryCat)*grams/10; } else
	 * if(userType.equals("priv")) { return getPricePer10gram("PL",
	 * "priv")*grams/10; } else if(userType.equals("irri")) { return
	 * getPricePer10gram("PL", "irri")*grams/10; } return null; }
	 */

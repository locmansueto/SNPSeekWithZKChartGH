...
public class ListboxMessageBox extends Messagebox implements Composer {
    ...
    /*
	@Listen("onSelect =#listboxOptions")
    ...
    */
	...
	public static final Object show(String message, String title, int buttons, String icon, List options, EventListener listener) throws InterruptedException {
		setTemplate(_templ);
	...
	public static final Object show(String message, String title, List options, EventListener listener) throws InterruptedException {
		setTemplate(_templ);
		
		showInput( message,  title, ListboxMessageBox.CANCEL|ListboxMessageBox.OK, ListboxMessageBox.INFORMATION, true,  options,  listener);
	...
	public static final int show1(String message, String title, List options) throws InterruptedException {
		...
		return show( message, title, ListboxMessageBox.CANCEL|ListboxMessageBox.OK ,INFORMATION, false, new org.zkoss.zk.ui.event.EventListener() {
			@Override
			public void onEvent(Event e) throws Exception {
				// TODO Auto-generated method stub
				if(e.getName().equals(ListboxMessageBox.ON_OK)) {
	...
	public static final	int showInput(String message, String title, int buttons, String icon, boolean focus,  List options, EventListener listener)	throws InterruptedException {
		...
		if(options.size()>20) listboxOptions.setHeight("200px"); 
		listboxOptions.setModel(new SimpleListModel(options));
		...
		if(listener!=null) dlg.setEventListener(listener);
	...
	public void doAfterCompose(Component arg0) throws Exception {
		...
		if(listboxOptions==null) listboxOptions = (Listbox)arg0.getFellowIfAny("listboxOptions");
	}

...
public class InputParamsIdxs {
	...
	public InputParamsIdxs(int startPosidx, int endPosidx, int listPosidx[], int listVaridx[], int listStartEndPosidx[][]) {
		this(startPosidx, endPosidx, listPosidx, listVaridx, listStartEndPosidx, null);
	}
	
	public InputParamsIdxs(int startPosidx, int endPosidx,
			int listPosidx[], int listVaridx[], int listStartEndPosidx[][], int startEndVaridx[]) {
		super();

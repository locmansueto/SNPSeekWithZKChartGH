...
public class IndelUni3024VarietiesAllele12v2TransposedDAO extends H5Dataset implements IndelsAllvarsDAO {
	...
	public Set<IndelsAllvars> findIndelAllvarsByChrPosBetween(String chr,
			BigDecimal start, BigDecimal end, List listpos) {
		// TODO Auto-generated method stub
		
		return null;
		//return readSNPString(chr,start.intValue(), end.intValue());
		//createIndelsAllvars(Map<BigDecimal,Long[]> allele1, Map<BigDecimal,String[]> allele2, List listpos
	}

	@Override
	public Set<IndelsAllvars> findIndelAllvarsByVarChrPosBetween(
			Collection varids, String chr, BigDecimal start, BigDecimal end,
			List listpos) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Set<IndelsAllvars> findIndelAllvarsByVarChrPosIn(Collection varList,
			String chr, int[][] posIdx, List listpos) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Set<IndelsAllvars> findIndelAllvarsByChrPosIn(String chr,
			int[][] posIdx, List listpos) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Set<IndelsAllvars> findIndelAllvarsByVarChrPosIn(Collection varList,
			String chr, Collection posList, List listpos) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public Set<IndelsAllvars> findIndelAllvarsByChrPosIn(String chr,
			Collection posList, List listpos) {
		// TODO Auto-generated method stub
		return null;
	}

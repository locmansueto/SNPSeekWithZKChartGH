...
@NamedQueries({
		...
		// @NamedQuery(name = "findVSnpSplicedonorByOrganismId", query = "select
		// myVSnpSplicedonor from VSnpSplicedonor myVSnpSplicedonor where
		// myVSnpSplicedonor.organismId = ?1"),
		...
		// @NamedQuery(name = "findVSnpSplicedonorByChrPositionBetween", query = "select
		// myVSnpSplicedonor from VSnpSplicedonor myVSnpSplicedonor where
		// myVSnpSplicedonor.chr=?1 and myVSnpSplicedonor.position between ?2 and ?3"),
		// @NamedQuery(name = "findVSnpSplicedonorByChrPositionIn", query = "select
		// myVSnpSplicedonor from VSnpSplicedonor myVSnpSplicedonor where
		// myVSnpSplicedonor.chr=?1 and myVSnpSplicedonor.position in (?2)"),
		...
		// @NamedQuery(name = "findVSnpSplicedonorBySrcfeatureId", query = "select
		// myVSnpSplicedonor from VSnpSplicedonor myVSnpSplicedonor where
		// myVSnpSplicedonor.srcfeatureId = ?1")
})

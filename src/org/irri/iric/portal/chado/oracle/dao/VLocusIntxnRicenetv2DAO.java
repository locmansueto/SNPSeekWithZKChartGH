...
public interface VLocusIntxnRicenetv2DAO extends JpaDao<VLocusIntxnRicenetv2>, FeatureInteractionDAO  {
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByFmax(BigDecimal fmax, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByFmin(BigDecimal fmin, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByScore(BigDecimal score, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByStrand(BigDecimal strand, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByContigName(String contigName_1) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByContigName
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByContigName(String contigName_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByCommonName
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByCommonName(String commonName_1) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByCommonName
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByCommonName(String commonName_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByNotesContaining
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByNotesContaining(String notes_1) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByNotesContaining
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByNotesContaining(String notes_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByNameContaining(String name_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public VLocusIntxnRicenetv2 findVLocusIntxnRicenetv2ByPrimaryKey(Integer featureId_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByQfeatureName(String qfeatureName_1) throws DataAccessException;

	/**
	 * JPQL Query - findVLocusIntxnRicenetv2ByQfeatureName
	 *
	 */
	public Set<VLocusIntxnRicenetv2> findVLocusIntxnRicenetv2ByQfeatureName(String qfeatureName_1, int startResult, int maxRows) throws DataAccessException;

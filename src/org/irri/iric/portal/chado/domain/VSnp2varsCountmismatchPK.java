...
/**
 */
public class VSnp2varsCountmismatchPK implements Serializable {
	private static final long serialVersionUID = 1L;

	/**
	 */
	public VSnp2varsCountmismatchPK() {
	}
	...
	public boolean equals(Object obj) {
		if (obj == this)
			return true;
		if (!(obj instanceof VSnp2varsCountmismatchPK))
			return false;
		VSnp2varsCountmismatchPK equalCheck = (VSnp2varsCountmismatchPK) obj;
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("VSnp2varsCountmismatchPK");

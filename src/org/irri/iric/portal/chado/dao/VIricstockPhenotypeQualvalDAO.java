...
public interface VIricstockPhenotypeQualvalDAO extends
	 ...
	 *
	 */
	public Set<VIricstockPhenotypeQualval> findVIricstockPhenotypeQualvalByPhenotypeId(BigDecimal phenotypeId_1) throws DataAccessException;

	/**
	 * JPQL Query - findVIricstockPhenotypeQualvalByPhenotypeId
	 *
	 */
	public Set<VIricstockPhenotypeQualval> findVIricstockPhenotypeQualvalByPhenotypeId(BigDecimal phenotypeId_1, int startResult, int maxRows) throws DataAccessException;

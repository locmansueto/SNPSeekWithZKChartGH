...
public class VIricstockDistanceDAOImpl extends AbstractJpaDao<VIricstockDistance>
	...
	public VIricstockDistance findVIricstockDistanceByPrimaryKey(Integer var1, Integer var2, int startResult, int maxRows) throws DataAccessException {
		try {
			...
			return (org.irri.iric.portal.chado.postgres.domain.VIricstockDistance) query.getSingleResult();
	...
	public Set<VIricstockDistance> findVIricstockDistanceByDistance(java.math.BigDecimal distance) throws DataAccessException {
		...
		return findVIricstockDistanceByDistance(distance, -1, -1);
	}
	...
	@SuppressWarnings("unchecked")
	@Transactional
	public Set<VIricstockDistance> findVIricstockDistanceByDistance(java.math.BigDecimal distance, int startResult, int maxRows) throws DataAccessException {
		Query query = createNamedQuery("findVIricstockDistanceByDistance", startResult, maxRows, distance);
		return new LinkedHashSet<VIricstockDistance>(query.getResultList());
	}

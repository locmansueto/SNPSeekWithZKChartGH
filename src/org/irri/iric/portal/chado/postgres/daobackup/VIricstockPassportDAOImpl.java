 ...
 * 
 */
@Repository("VIricstockPassportDAO")
@Primary()
@Transactional
public class VIricstockPassportDAOImpl extends AbstractJpaDao<VIricstockPassport>
	...
	public VIricstockPassport findVIricstockPassportByPrimaryKey(Integer iricStockpropId, int startResult, int maxRows) throws DataAccessException {
		try {
			...
			return (org.irri.iric.portal.chado.postgres.domain.VIricstockPassport) query.getSingleResult();
	...
	public Set findIricstockPassportByIricStockId(BigDecimal id) {
		...
		return findVIricstockPassportByIricStockId(id.intValue());
	}

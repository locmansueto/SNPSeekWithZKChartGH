...
@NamedQueries({
		...
		@NamedQuery(name = "PGfindVPatoOrganismByCvCommonName", query = "select myVPatoOrganism from VPatoOrganism myVPatoOrganism where  myVPatoOrganism.cvName = ?1 and myVPatoOrganism.commonName = ?2"),
...
@Table(schema = "public", name = "v_pato_organism")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "iric_prod_crud/org/irri/iric/portal/chado/postgres/domain", name = "VPatoOrganism")

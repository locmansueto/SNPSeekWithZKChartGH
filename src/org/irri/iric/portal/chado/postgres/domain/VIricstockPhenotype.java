...
@NamedQueries({
		...
		@NamedQuery(name = "findVIricstockPhenotypeByNameContaining", query = "select myVIricstockPhenotype from VIricstockPhenotype myVIricstockPhenotype where myVIricstockPhenotype.name like ?1"),
...
@Table(schema = "public", name = "v_iricstock_phenotype")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "iric_prod_crud/org/irri/iric/portal/chado/postgres/domain", name = "VIricstockPhenotype")

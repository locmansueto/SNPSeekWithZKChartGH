...
public class VIricstockPassportValuesDAOImpl extends AbstractJpaDao<VIricstockPassportValues>
	 ...
	 */
	@Transactional
	public Set<VIricstockPassportValues> findVIricstockPassportValuesByTypeId(BigDecimal typeId, String dataset) throws DataAccessException {
	...
	@Transactional
	public Set<VIricstockPassportValues> findVIricstockPassportValuesByTypeId(BigDecimal typeId, String dataset, int startResult, int maxRows) throws DataAccessException {

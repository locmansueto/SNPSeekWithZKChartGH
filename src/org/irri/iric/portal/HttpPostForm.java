...
public class HttpPostForm {
	...
	public void postRicenetNetworkNGA2(String genelist) throws Exception {
		...
		try {
			...
			formparams.add(new BasicNameValuePair("modelspecies", "0"));
			formparams.add(new BasicNameValuePair("genes", genelist));
			UrlEncodedFormEntity entity = new UrlEncodedFormEntity(
					(Iterable<? extends org.apache.http.NameValuePair>) formparams, Consts.UTF_8);

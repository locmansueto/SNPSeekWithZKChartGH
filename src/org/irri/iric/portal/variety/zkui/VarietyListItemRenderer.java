...
public class VarietyListItemRenderer implements ListitemRenderer {
	...
	public void render(Listitem listitem, Object value, int index) throws Exception {
		// TODO Auto-generated method stub
	        ...
	        /*
	        if(item instanceof VHdrastockBasicprop) {	        	
	        ...
	        */
	        ...
	        if(item.getSubpopulation()==null || item.getSubpopulation().isEmpty())
	        	addListcell(listitem,"");
	        else addListcell(listitem, item.getSubpopulation() , "color:" + Data.getSubpopulationColor(  item.getSubpopulation()));
	        ...
	        /*
	        if(item instanceof VHdrastockBasicprop) {}
	        else  addListcell(listitem, item.getCountry());
	        */
	        ...
	        if(!isBasic) {
		        if(item instanceof VarietyPlusPlus) {
		        	...
		        	while(itValname.hasNext()) {
		        		...
		        		else if(val!=null) strval = val.toString();
		        		
		        		if(valname.toString().toLowerCase().equals("genotype"))
		        		{
		        			String style="color:black;align:center";
		        			if(strval.equals("A")) style=SNPRowRendererStyle.STYLE_A;
		        			else if(strval.equals("C")) style=SNPRowRendererStyle.STYLE_C;
		        			else if(strval.equals("G")) style=SNPRowRendererStyle.STYLE_G;
		        			else if(strval.equals("T")) style=SNPRowRendererStyle.STYLE_T;
		        			else if(strval.contains("/")) style=SNPRowRendererStyle.STYLE_HETERO;

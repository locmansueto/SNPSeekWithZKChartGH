...
public class GenesetWebClient {
	...
	public List<String> submitGeneset(Collection sites, Collection geneset, String delimiter,  boolean isDisplay) {
		...
		while(itGene.hasNext()) {
			...
			if(itGene.hasNext()) genelist.append(delimiter);
		}
	...
	public List<String> submitGeneset(Collection sites, String genelist, boolean isDisplay) {
		...
		if(sites.contains(RicenetNetworkNGA)) {
			 ...
			 listUrls.add(url);
			 if(isDisplay) Executions.getCurrent().sendRedirect(url, "_ricenetnga");
		}
		if(sites.contains(RicenetContextHub)) {
			 String url=postRicenetContexthub(genelist.toString());
			 listUrls.add(url);
			 if(isDisplay) Executions.getCurrent().sendRedirect(url, "_ricenetcontext");
		}
		return listUrls;
	}
	 ...
	 private String postRicenetNetworkNGA(String genelist) {
		 ...
		 System.setProperty( "phantomjs.binary.path", AppContext.getPhantomjsExe());
	        ...
	        //element.sendKeys("LOC_Os01g32460 LOC_Os01g32380 LOC_Os08g34740 LOC_Os09g30412 LOC_Os02g33180 LOC_Os12g36880 LOC_Os06g49430 LOC_Os02g54600 LOC_Os01g32660 LOC_Os03g17700 LOC_Os10g38950 LOC_Os01g47530 LOC_Os05g45420 LOC_Os01g14810 LOC_Os02g57200 LOC_Os10g28610 LOC_Os03g12470 LOC_Os01g49290 LOC_Os01g12900 LOC_Os05g02130 LOC_Os06g06090 LOC_Os01g25820");
	 ...
	 private String postRicenetContexthub(String genelist) {
		 System.setProperty( "phantomjs.binary.path", AppContext.getPhantomjsExe());
	        ...
	        //Executions.getCurrent().sendRedirect(driver.getCurrentUrl(), "_ricenetcontext");
...
//	 
		public static void main(String[] args) {
			...
			client.submitGeneset(sites,"LOC_Os01g32460 LOC_Os01g32380 LOC_Os08g34740 LOC_Os09g30412 LOC_Os02g33180 LOC_Os12g36880 LOC_Os06g49430 LOC_Os02g54600 LOC_Os01g32660 LOC_Os03g17700 LOC_Os10g38950 LOC_Os01g47530 LOC_Os05g45420 LOC_Os01g14810 LOC_Os02g57200 LOC_Os10g28610 LOC_Os03g12470 LOC_Os01g49290 LOC_Os01g12900 LOC_Os05g02130 LOC_Os06g06090 LOC_Os01g25820",true);

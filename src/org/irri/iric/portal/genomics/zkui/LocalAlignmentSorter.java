...
public class LocalAlignmentSorter implements Comparator {
	...
	public int compare(Object o1, Object o2) {
	    ...
	    */
		switch(index) {
			case 0: temp1=l1.getQacc(); temp2=l2.getQacc(); break;
			case 1: temp1=l1.getQstart(); temp2=l2.getQstart(); break;
			case 2: temp1=l1.getQend(); temp2=l2.getQend(); break;
			case 3: temp1=l1.getSacc(); temp2=l2.getSacc(); break;
			case 4: temp1=l1.getSstart(); temp2=l2.getSstart(); break;
			case 5: temp1=l1.getSend(); temp2=l2.getSend(); break;
			case 6: temp1=l1.getSstrand(); temp2=l2.getSstrand(); break;
			case 7: temp1=l1.getMatches(); temp2=l2.getMatches(); break;
			case 8: temp1=l1.getEvalue(); temp2=l2.getEvalue(); break;
		}

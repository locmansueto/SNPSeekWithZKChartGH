...
public interface LocusService {
	...
	public List getCDSByContigPositions(String contig, Collection posset, String organism, Integer plusminus, String genemodel);
	...
	Map[] getMarkerGenomicAnnotsByContigPositions(String contig, Collection colPos, Integer plusminus, String genemodel);
